...
export const WhyChooseUsSection = () => {
  return (
    <div className="container grid grid-cols-2 gap-4">
      {items.map((item, idx) => (
        <div className="text-secondary bg-background cursor-pointer border border-[#18243A] p-8 transition-colors duration-300 hover:border-[#FFB63F] hover:text-[#FFB63F]">
